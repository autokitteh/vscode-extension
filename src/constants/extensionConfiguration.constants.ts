...
export const INITIAL_DEPLOYMENTS_RETRY_SCHEDULE_INTERVAL = 60;
export const INITIAL_SESSION_LOG_RETRY_SCHEDULE_INTERVAL = 5;
export const INITIAL_PROJECTS_RETRY_SCHEDULE_INTERVAL = 60;
